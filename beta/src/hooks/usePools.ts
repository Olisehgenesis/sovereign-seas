...
const POOLS_CONTRACT_ADDRESS = import.meta.env.VITE_POOLS_CONTRACT_ADDRESS as Address

// Log contract address for debugging
console.log('Pools Contract Address:', POOLS_CONTRACT_ADDRESS)
console.log('Environment Variable:', import.meta.env.VITE_POOLS_CONTRACT_ADDRESS)
