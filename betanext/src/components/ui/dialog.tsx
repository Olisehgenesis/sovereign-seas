...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // High z-index so it always sits above page content, bottom nav, etc.
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out " +
            ...
            // Match overlay z-index so content is fully above the page
            "fixed inset-x-0 top-[10vh] z-[80] mx-auto grid w-full max-w-[calc(100%-2rem)] " +
