        ...
        <div className="flex items-center justify-center">
          <div className="group relative w-full max-w-md">
            ...
            >
              ...
              >
                <h3 className="text-[0.9em]">Error Loading Projects</h3>
              </div>

              {/* Body */}
              <div className="relative px-[1.2em] py-[1em] z-[2] text-center">
                <p className="text-[#050505] text-[0.9em] font-semibold">There was an error loading the projects. Please try again later.</p>
              </div>
            </div>
          </div>
        </div>
