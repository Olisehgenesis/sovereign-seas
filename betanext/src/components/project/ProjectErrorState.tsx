    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="group relative w-full max-w-md">
        ...
        >
          ...
          >
            <h3 className="text-[0.9em]">Project Not Found</h3>
          </div>

          {/* Body */}
          <div className="relative px-[1.2em] py-[1em] z-[2] text-center">
            <div className="text-6xl mb-8">🚀</div>
            <h1 className="text-3xl font-extrabold text-[#050505] mb-4 uppercase tracking-[0.05em]">Project Not Found</h1>
            <p className="text-[#050505] text-[0.9em] font-semibold leading-relaxed">
