...
export const KNOWN_TOKENS: { [key: string]: TokenInfo } = {
  ...
  [process.env.NEXT_PUBLIC_GOOD_DOLLAR_TOKEN || '0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A']: {
    symbol: 'G$',
    name: 'GoodDollar',
    decimals: 18,
...
export const tokenList = [
  ...
  {
    address: process.env.NEXT_PUBLIC_GOOD_DOLLAR_TOKEN || '0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A',
    symbol: 'G$',
    name: 'GoodDollar',
    decimals: 18,
