...
const csp = [
  ...
  "img-src 'self' data: blob: https://i.postimg.cc https://auth.privy.io https://ipfs.io https://gateway.pinata.cloud https://*.pinata.cloud",
  "font-src 'self'",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
  "frame-ancestors 'self' http://localhost:5173 https://sovseas.xyz https://www.sovseas.xyz https://auth.privy.io",
