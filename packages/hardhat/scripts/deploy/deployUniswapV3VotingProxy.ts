...
import uniswapV3VotingProxyAbi from '../../artifacts/contracts/UniswapV3VotingProxy.sol/UniswapV3VotingProxy.json';
...
try {
  contractBytecode = uniswapV3VotingProxyAbi.bytecode;
...
async function deployUniswapV3VotingProxy() {
  try {
    console.log('Deploying UniswapV3VotingProxy contract...');
    ...
    let abi = uniswapV3VotingProxyAbi.abi;
    ...
    const hash = await walletClient.deployContract({
      abi: uniswapV3VotingProxyAbi.abi,
    ...
    console.log('');
    console.log('Add this address to your .env file as UNISWAP_V3_VOTING_PROXY_ADDRESS to use it with your application.');
    console.log('');
