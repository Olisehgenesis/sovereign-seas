...
async function deployUniswapV3VotingProxyInternal() {
  try {
...
export async function deployUniswapV3VotingProxy(network?: string) {
  return await deployUniswapV3VotingProxyInternal();
} 