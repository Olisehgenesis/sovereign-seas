...
async function verifyContract() {
  try {
    console.log('Verifying UbeswapVotingProxy contract...');
    ...
    const command = `npx hardhat verify --network ${targetNetwork} ${UBESWAP_VOTING_PROXY_ADDRESS} ${constructorArgs.join(' ')}`;
