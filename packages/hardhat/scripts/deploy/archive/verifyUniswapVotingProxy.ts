...
// Determine the network from RPC URL or environment
const isMainnet = RPC_URL.includes('rpc.ankr.com/celo') || process.env.NETWORK === 'celo';
...
async function verifyContract() {
  try {
    ...
    console.log(`Contract address: ${UNISWAP_VOTING_PROXY_ADDRESS}`);
    ...
    await run('verify:verify', {
      address: UNISWAP_VOTING_PROXY_ADDRESS,
